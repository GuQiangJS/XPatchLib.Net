...
namespace XPatchLib
{
    ...
    class XmlTextReader1 : ITextReader
    {
        ...
        public XmlTextReader1(Stream input) : this()
        {
        ...
        public XmlTextReader1(TextReader input) : this()
        {
            _reader = input;
            ReadData();
        }
        ...
        private readonly Dictionary<String, String> _emptyAttributes = new Dictionary<string, string>(0);
