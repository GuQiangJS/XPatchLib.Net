...
namespace XPatchLib.UnitTest
{
    ...
    public class TestSerializeObject
    {
        ...
        public void CultureChangeTest()
        {
            ...
            serializer = new XPatchSerializer(typeof(CultureClass), XmlDateTimeSerializationMode.Unspecified);
  ...
  <Name>{0}</Name>
        ...
        public void TestCombineErrorPrimaryKeyDefineClass()
        {
            ...
            catch (PrimaryKeyException ex)
            {
                ...
                Assert.AreEqual(
                    string.Format(CultureInfo.InvariantCulture, " '{0}' 的 主键 {1} 设置异常.", ex.SourceType.Name,
