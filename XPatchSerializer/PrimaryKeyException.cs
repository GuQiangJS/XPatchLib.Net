...
namespace XPatchLib
{
    ...
    public class PrimaryKeyException : Exception
    {
        ...
        public override string Message
        {
            ...
            {
                //TODO:多语言
                return string.Format(CultureInfo.InvariantCulture, " '{0}' 的 主键 {1} 设置异常.", this.SourceType.Name, this.PrimaryKeyName);
            }
        }
        ...
        public override void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddValue("PrimaryKeyName", this.PrimaryKeyName);
