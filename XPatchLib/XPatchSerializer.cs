...
namespace XPatchLib
{
    ...
    ///         <code language="c#" source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\ClassRemark.cs" />
    ///         <para>
    ///             当原始对象的ObjectName的值为 "My String" ，更新后的对象将ObjectName的值设置为"My String New"时，序列化增量内容的 XML 输出如下所示：
    ///         </para>
    ///         <code language="xml" source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\ClassRemarkOutput.xml" />
    ...
    ///     </para>
    ///     <code language="c#" source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\ClassExample.cs" />
    ///     <para> 序列化增量内容的 XML 输出如下所示： </para>
    ///     <code language="xml" source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\ClassExampleOutPut.xml" />
    /// </example>
    public class XmlSerializer
    {
        ...
        ///     </para>
        ///     <code language="c#" source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\ConstructorExample.cs" />
        ///     <para> 序列化增量内容的 XML 输出如下所示： </para>
        ///     <code language="xml" source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\ConstructorExampleOutPut.xml" />
        /// </example>
        ...
        ///     </para>
        ///     <code language="c#"
        ///         source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\ConstructorSerializeDefalutValueExample.cs" />
        ///     <para> 序列化增量内容的 XML 输出如下所示： </para>
        ///     <code language="xml"
        ///         source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\ConstructorSerializeDefalutValueExampleOutPut.xml" />
        /// </example>
        ...
        ///     </para>
        ///     <code language="c#" source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\ConstructorDateModeExample.cs" />
        ///     <para> 序列化增量内容的 XML 输出如下所示： </para>
        ///     <code language="xml"
        ///         source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\ConstructorDateModeExampleOutPut.xml" />
        /// </example>
        ...
        ///     </para>
        ///     <code language="c#"
        ///         source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\ConstructorDateModeSerializeDefalutValueExample.cs" />
        ///     <para> 序列化增量内容的 XML 输出如下所示： </para>
        ///     <code language="xml"
        ///         source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\ConstructorDateModeSerializeDefalutValueExampleOutPut.xml" />
        /// </example>
        ...
        ///     <code language="c#" source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\CombineStreamExample.cs" />
        ///     <code language="xml" title="patch.xml"
        ///         source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\CombineStreamExampleInPut.xml" />
        /// </example>
        ...
        /// <example>
        ///     <para> 下面的示例使用 <c> Stream </c> 对象反序列化增量内容，并附加至原始对象。 </para>
        ///     <code language="c#" source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\CombineStreamOverrideExample.cs" />
        ///     <code language="xml" title="patch.xml"
        ///         source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\CombineStreamExampleInPut.xml" />
        /// </example>
        ...
        ///     <code language="c#" source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\CombineTextReaderExample.cs" />
        ///     <code language="xml" title="patch.xml"
        ///         source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\CombineTextReaderExampleInPut.xml" />
        /// </example>
        ...
        ///     <para> 下面的示例使用 <c> TextReader </c> 对象反序列化增量内容，并附加至原始对象。 </para>
        ///     <code language="c#"
        ///         source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\CombineTextReaderOverrideExample.cs" />
        ///     <code language="xml" title="patch.xml"
        ///         source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\CombineTextReaderExampleInPut.xml" />
        /// </example>
        ...
        /// <example>
        ///     <para> 下面的示例使用 <c> TextReader </c> 对象反序列化增量内容，并附加至原始对象。 </para>
        ///     <code language="c#" source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\CombineXmlReaderExample.cs" />
        ///     <code language="xml" title="patch.xml"
        ///         source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\CombineXmlReaderExampleInPut.xml" />
        /// </example>
        ...
        ///     <para> 下面的示例使用 <c> TextReader </c> 对象反序列化增量内容，并附加至原始对象。 </para>
        ///     <code language="c#"
        ///         source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\CombineXmlReaderOverrideExample.cs" />
        ///     <code language="xml" title="patch.xml"
        ///         source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\CombineXmlReaderExampleInPut.xml" />
        /// </example>
        ...
        ///     <code language="c#" source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\DivideStreamExample.cs" />
        ///     <para> 序列化增量内容的 XML 输出如下所示： </para>
        ///     <code language="xml" title="patch.xml"
        ///         source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\DivideStreamExampleOutPut.xml" />
        /// </example>
        ...
        ///     <code language="c#" source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\DivideTextWriterExample.cs" />
        ///     <para> 序列化增量内容的 XML 输出如下所示： </para>
        ///     <code language="xml" title="patch.xml"
        ///         source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\DivideTextWriterExampleOutPut.xml" />
        /// </example>
        ...
        ///     <code language="c#" source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\DivideXmlWriterExample.cs" />
        ///     <para> 序列化增量内容的 XML 输出如下所示： </para>
        ///     <code language="xml" title="patch.xml"
        ///         source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\DivideXmlWriterExampleOutPut.xml" />
        /// </example>
        ...
        ///     </para>
        ///     <code language="c#" source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\RegisteTypesExample.cs" />
        ///     <para> 序列化增量内容的 XML 输出如下所示： </para>
        ///     <code language="xml" title="patch.xml"
        ///         source="..\..\XmlSerializer.Example\CSharp\XmlSerializer\RegisteTypesExampleOutPut.xml" />
        /// </example>
