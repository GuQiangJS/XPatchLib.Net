...
namespace XPatchSerializerExample
{
    ...
    public class PerformanceBigCollectionAnalysis
    {
        ...
        private static void Test()
        {
            ...
            BeginTime = System.DateTime.Now;
            System.Reflection.PropertyInfo cpi = m.GetType().GetProperty("Id");
            for (int i = 0; i < max; i++)
            {
        ...
        private static void TestXmlSerializer()
        {
            ...
            EndTime = System.DateTime.Now;
            ts = EndTime.Subtract(BeginTime);
            Write(string.Format("XmlSerializer Serialize:{0}.", ts.ToString()));
            ...
            EndTime = System.DateTime.Now;
            ts = EndTime.Subtract(BeginTime);
            Write(string.Format("XmlSerializer Deserialize:{0}.", ts.ToString()));
            Write("----------------------------");
        }
        ...
        private static void TestXPatchLib(Boolean pOverride)
        {
            ...
            XPatchSerializer serializer = new XPatchSerializer(typeof(MovieCollection));
            ...
            EndTime = System.DateTime.Now;
            ts = EndTime.Subtract(BeginTime);
            Write(string.Format("XPatchLib Divide:{0}.", ts.ToString()));
            ...
            EndTime = System.DateTime.Now;
            ts = EndTime.Subtract(BeginTime);
            Write(string.Format("XPatchLib Combine Override:{1}:{0}.", ts.ToString(), pOverride));
            Write("----------------------------");
        }
        ...
        private static void TestXPatchLibNull()
        {
            ...
            EndTime = System.DateTime.Now;
            ts = EndTime.Subtract(BeginTime);
            Write(string.Format("XPatchLib Divide Null:{0}.", ts.ToString()));
            ...
            EndTime = System.DateTime.Now;
            ts = EndTime.Subtract(BeginTime);
            Write(string.Format("XPatchLib Combine Null:{0}.", ts.ToString()));
            Write("----------------------------");
        }
        ...
        private static void Write(String msg)
        {
            ...
            File.AppendAllLines(LOGFILE, new string[] { msg, System.Environment.NewLine });
        }
    }
